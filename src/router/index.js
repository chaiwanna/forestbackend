...
const router = new Router({
  ...
  routes: [
    ...
    },
    {
      path: '/information',
      name: 'information',
      component: () => import(/* webpackChunkName: "setting" */ '../views/Information/Information.vue'),
      meta: {
        layout: 'backend-layout',
        requiresAuth: true
      }
    },
    {
      path: '/register/new',
      name: 'register',
      component: () => import(/* webpackChunkName: "setting" */ '../views/Register/Register.vue')
      
    },
    {
      path: '/registerForest',
      name: 'registerForest',
      component: () => import(/* webpackChunkName: "setting" */ '../views/Register/ResgisterForest'),
      meta: {
        requiresAuth: true
      }
    }
